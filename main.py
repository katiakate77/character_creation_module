...
def choice_char_class(char_name: str) -> Character:
    ...
    Возвращает объект выбранного пользователем класса
    с переданным ему именем персонажа.
    """
    # Словарь, в котором соотносится
    ...
    while approve_choice != 'y':
        ...
        char_class: Character = game_classes.get(selected_class)
        if char_class is not None:
            char_obj = char_class(char_name)
        else:
            raise ValueError('Нет такого названия персонажа')
...
def start_training(character):
    ...
    который возвращает функция choice_char_class(char_name).
